...
const movieRatings = movieDetails.filter((item)=> item.rating >= 6 && item.rating<=7);
// console.log(movieRatings); => only five items...

const movieNames = movieDetails.map((name)=>console.log(name.movie));
// console.log(movieNames); => [] empty object because you don't have any condition......

// But, if you want to return values without using any condition then use map method.....
